      ...
      <div className={styles.avatarContainer}>
        ...
        <div className={styles.avatarBorder}>
          <div className={styles.avatarInner}>
            ...
            <svg viewBox="0 0 100 100" className="w-28 h-28 mt-4 md:w-32 md:h-32" style={{ width: "8rem", height: "8rem" }}>
              <defs>
              ...
              {/* Smile */}
              <path d="M46 48 Q50 52 54 48" fill="none" stroke="#0f172a" strokeWidth="2" strokeLinecap="round" />
              {/* Neck */}
      ...
      <div className={styles.headlineWrap}>
        <h1 className={styles.title}>
          ...
          <svg viewBox="0 0 24 24" className={`${styles.sparkleLeft} floating-shape-3`}>
            <path fill="currentColor" d="M12,2L14.5,9.5L22,12L14.5,14.5L12,22L9.5,14.5L2,12L9.5,9.5Z" />
          </svg>
          ...
          <svg viewBox="0 0 24 24" className={`${styles.sparkleRight} floating-shape-1`}>
            <path fill="currentColor" d="M12,2L13.5,8.5L20,10L13.5,11.5L12,18L10.5,11.5L4,10L10.5,8.5Z" />
          </svg>
        </h1>
        ...
        <p className={styles.desc}>
          Computer Engineering graduate from Khon Kaen University. Interested in <strong>backend development</strong> and <strong>distributed systems</strong>. A disciplined, detail-oriented individual who takes full ownership of work and approaches challenges with a logical mindset. Ready to adapt and collaborate to support system development.
        </p>
      </div>
