    ...
    >
      ...
      >
        <svg viewBox="0 0 100 100" className="w-full h-full">
          ...
          {/* Main Body/Head */}
          <rect x="25" y="20" width="50" height="45" rx="12" fill="url(#botBody)" stroke="#ffffff" strokeWidth="2" />
          <rect x="25" y="20" width="50" height="45" rx="12" fill="none" stroke="#60a5fa" strokeWidth="1" transform="translate(1, 1)" opacity="0.5" />
          
          {/* Visor */}
          <rect x="30" y="32" width="40" height="18" rx="6" fill="url(#visorGrad)" stroke="#334155" strokeWidth="2" />
          <path d="M 32 35 Q 40 33 48 35" fill="none" stroke="#ffffff" strokeWidth="1.5" opacity="0.3" strokeLinecap="round" />
          
          {/* Glowing Eyes */}
          <rect x="36" y="38" width="28" height="6" rx="3" fill="url(#eyeGlow)" style={{ filter: "drop-shadow(0 0 3px #38bdf8)" }} />
