...
export const experienceData: ExperienceItem[] = [
  {
    ...
    responsibilities: {
      ...
      th: [
        "ช่วยสนับสนุนการดูแลพอร์ทัลผู้ดูแลระบบ <strong>SCB Planet X</strong> โดยพัฒนาฟีเจอร์และแก้ไขข้อผิดพลาดตามความต้องการของลูกค้า",
        "พัฒนาการทดสอบแบบหน่วย (Unit Tests) ด้วย <strong>Jest</strong> เพื่อความถูกต้องของคุณภาพโค้ด พร้อมทั้งเรียนรู้สถาปัตยกรรมของโครงการจริง",
        "รวมระบบช่องทางชำระเงินภายใน <strong>DigiPay</strong> เข้ากับระบบ DigiShop เพื่อดูแลและตรวจสอบขั้นตอนการโอนเงินที่ปลอดภัย",
        "ศึกษาระบบธุรกรรมและการโอนเงินทางการเงิน เพื่อนำความรู้มาออกแบบและพัฒนาบนโปรเจกต์ส่วนตัวได้อย่างสมบูรณ์",
      ],
    },
  },
]
